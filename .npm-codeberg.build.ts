...
await invokeDenoNodeJSTransformer({
	...
	metadata: {
		...
		homepage: "https://codeberg.org/hugoalh/is-empty-es#readme",
		bugs: {
			url: "https://codeberg.org/hugoalh/is-empty-es/issues"
		},
		license: "MIT",
		author: "hugoalh",
		repository: {
			type: "git",
			url: "git+https://codeberg.org/hugoalh/is-empty-es.git"
		},
		private: false,
		publishConfig: {
			access: "public"
